	...
	return (
		<div className='AbnormalResultsSagittal_AbnormalResultsSagittal'>
			...
			<div className='OuterButtons'>
				<div className='Axial'>
					<img className='Rectangle1_1' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_1} />
					<span className='Abnormal'>Abnormal</span>
				</div>
				<Link to='/aclresultscoronal'>
					<div className='ACLButton'>
						<img className='Rectangle1_2' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_2} />
						<span className='ACL'>ACL</span>
					</div>
				</Link>
				<Link to='/meniscusresultscoronal'>
					<div className='MeniscusButton'>
						<img className='Rectangle1_3' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_3} />
						<span className='Meniscus'>Meniscus</span>
					</div>
				</Link>
				<Link to='/totalresults'>
					<div className='TotalButton'>
						<img className='Rectangle1_4' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_4} />
						<span className='Total'>Total</span>
					</div>
				</Link>
			</div>
			<img className='Overlay' src = {ImgAsset.AbnormalResultsSagittal_Overlay} />
			<img className='PlayButton' src = {ImgAsset.AbnormalResultsSagittal_PlayButton} />
			<div className='PauseButton'>
				<div className='Rectangle6'/>
				<div className='Rectangle7'/>
			</div>
			<div className='GradCamButton'>
				<img className='Rectangle1_5' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_5} />
				<span className='GradCAM_1'>Grad-CAM</span>
			</div>
			<div className='InnerButtons'>
				<Link to='/abnormalresultscoronal'>
					<div className='CoronalButton'>
						<img className='Rectangle1_6' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_6} />
						<span className='Coronal_1'>Coronal</span>
					</div>
				</Link>
				<Link to='/abnormalresultsaxial'>
					<div className='AxialButton'>
						<img className='Rectangle1_7' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_7} />
						<span className='Axial_1'>Axial</span>
					</div>
				</Link>
				<div className='SagittalButton'>
					<img className='Rectangle1_8' src = {ImgAsset.AbnormalResultsSagittal_Rectangle1_8} />
